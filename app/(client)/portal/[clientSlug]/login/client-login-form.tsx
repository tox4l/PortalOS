  ...
  return (
    <div className="flex min-h-[80dvh] flex-col items-center justify-center px-5">
      <div className="w-full max-w-[440px] space-y-8">
        ...
        {/* Agency user banner — no auto-redirect, just a message + link */}
        {isAgencyUser && (
          <div className="rounded-[8px] border border-[var(--border-gold-dim)] bg-[var(--gold-wash)] p-4 text-center">
            <p className="text-[14px] leading-[1.5] text-[var(--ink-primary)]">
              You are signed in as an agency user.{" "}
              <Link
                className="font-medium text-[var(--gold-core)] underline underline-offset-2 transition-colors hover:text-[var(--gold-mid)]"
                href="/app/dashboard"
              >
...
export function ClientLoginForm({
  ...
  return (
    <Suspense fallback={null}>
      <LoginForm clientSlug={clientSlug} isAgencyUser={isAgencyUser} />
    </Suspense>
  );
}
